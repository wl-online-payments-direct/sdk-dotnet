...
namespace OnlinePayments.Sdk.Domain
{
    public class SurchargeForPaymentLink
    {
        ...
        ///   <item><description>on-behalf-of - Merchant to instruct the payment platform to calculate and apply a surcharge amount to a transaction, based on the merchant’s surcharge configuration, net amount, and payment product type.</description></item>
        /// </list>
        /// </summary>
