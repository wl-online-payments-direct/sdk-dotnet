...
namespace OnlinePayments.Sdk.Domain
{
    public class SubsequentCardPaymentMethodSpecificInput
    {
        ...
        ///   * PartialShipment - I-P e-Commerce scenario whereby credentials have been stored to enable subsequent MITs per shipment. For this type of use case, PartialShipment is expected on both the initial CIT and eventual subsequent MITs to complete the order.<para />
