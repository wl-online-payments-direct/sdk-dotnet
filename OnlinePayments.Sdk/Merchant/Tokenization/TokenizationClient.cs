...
namespace OnlinePayments.Sdk.Merchant.Tokenization
{
    ...
    /// </summary>
    public class TokenizationClient : ApiResource, ITokenizationClient
    {
        public TokenizationClient(ApiResource parent, IDictionary<string, string> pathContext) :
        ...
        public async Task<CreateCertificateResponse> CreateCertificate(CsrRequest body, CallContext context = null)
        {
        ...
        ///            or the service that you're trying to reach is temporary unavailable (HTTP status code 500, 502 or 503)</exception>
        /// <exception cref="ApiException">if the payment platform returned any other error</exception>
        public async Task<DetokenizationResponse> GetCardDataByTokens(GetCardDataByTokensParams query, CallContext context = null)
        {
        ...
        ///            or the service that you're trying to reach is temporary unavailable (HTTP status code 500, 502 or 503)</exception>
        /// <exception cref="ApiException">if the payment platform returned any other error</exception>
        public async Task<DetokenizationResponse> GetCardDataByPayments(GetCardDataByPaymentsParams query, CallContext context = null)
        {
