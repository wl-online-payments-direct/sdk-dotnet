...
namespace OnlinePayments.Sdk.Merchant.HostedFields
{
    ...
    /// </summary>
    public interface IHostedFieldsClient
    {
        /// <summary>
        ...
        Task<CreateHostedFieldsSessionResponse> CreateHostedFieldsSession(CreateHostedFieldsSessionRequest body, CallContext context = null);
        ...
        ///            or the service that you're trying to reach is temporary unavailable (HTTP status code 500, 502 or 503)</exception>
        /// <exception cref="ApiException">if the payment platform returned any other error</exception>
        Task<GetHostedFieldsSessionResponse> GetHostedFieldsSession(string sessionId, CallContext context = null);
