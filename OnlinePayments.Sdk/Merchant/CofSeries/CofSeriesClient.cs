...
namespace OnlinePayments.Sdk.Merchant.CofSeries
{
    ...
    /// </summary>
    public class CofSeriesClient : ApiResource, ICofSeriesClient
    {
        public CofSeriesClient(ApiResource parent, IDictionary<string, string> pathContext) :
        ...
        /// </summary>
        /// <param name="body">ImportCofSeriesRequest</param>
        /// <param name="context">CallContext</param>
        /// <returns>ImportCofSeriesResponse</returns>
        ...
        public async Task<ImportCofSeriesResponse> ImportCofSeries(ImportCofSeriesRequest body, CallContext context = null)
        {
