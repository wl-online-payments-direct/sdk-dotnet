...
namespace OnlinePayments.Sdk.Merchant.PreAuthorization
{
    ...
    public interface IPreAuthorizationClient
    {
        ...
        Task<IncrementAuthorizationResponse> IncrementAuthorization(string paymentId, IncrementAuthorizationRequest body, CallContext context = null);
        ...
        ///            or the service that you're trying to reach is temporary unavailable (HTTP status code 500, 502 or 503)</exception>
        /// <exception cref="ApiException">if the payment platform returned any other error</exception>
        Task<AddAuthorizationDetailsResponse> AddAuthorizationDetails(string paymentId, UpdateAuthorizationAdditionalDataRequest body, CallContext context = null);
