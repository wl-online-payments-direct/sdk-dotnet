...
{
    /// <summary>
    /// Thrown when a response was received from the payment platform which indicates an error.
    /// </summary>
    public class ResponseException : Exception
    {
        ...
        /// <summary>
        /// Gets the headers that were returned by the payment platform.
        /// </summary>
        ...
        /// <summary>
        /// Returns a <see cref="T:System.String"/> that represents the current <see cref="T:OnlinePayments.Sdk.ResponseException"/>.
        /// </summary>
        /// <returns>A <see cref="T:System.String"/> that represents the current <see cref="T:OnlinePayments.Sdk.ResponseException"/>.</returns>
