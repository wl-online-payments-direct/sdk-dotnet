   ...
   ""errors"" : [ {
    ...
    ""paymentResult"": {
        ...
        public async Task TestCreateSuccess()
        {
            ...
            IClient client = Factory.CreateClient(apiEndpoint, connectionMock.Object, new DefaultAuthenticator(AuthorizationType.V1HMAC, "test", "test"), new MetaDataProvider("OnlinePayments"));

            CreatePaymentRequest body = CreateRequest();

            CreatePaymentResponse response = await client.WithNewMerchant("merchantId").Payments.CreatePayment(body)
        ...
        public async Task TestCreateRejected()
        {
            ...
            try
            {
                await client.WithNewMerchant("merchantId").Payments.CreatePayment(body)
                    .ConfigureAwait(false);
            ...
            catch (DeclinedPaymentException e)
            {
                ...
                Assert.That(e.CreatePaymentResponse, Is.Not.Null);
                Assert.That(e.CreatePaymentResponse.Payment.Id, Is.EqualTo("000002000020142544360000100001"));
                Assert.That(e.CreatePaymentResponse.Payment.Status, Is.EqualTo("REJECTED"));
            }
        }
        ...
        public async Task TestCreateIdempotenceError()
        {
            ...
            try
            {
                await client.WithNewMerchant("merchantId").Payments.CreatePayment(body, context)
                    .ConfigureAwait(false);
