...
namespace Ingenico.Direct.Sdk
{
    ...
    public class FactoryTest
    {
        ...
        public void TestCreateConfiguration()
        {
            ...
            Assert.AreEqual(new Uri("https://payment.preprod.direct.ingenico.com"), configuration.ApiEndpoint);
