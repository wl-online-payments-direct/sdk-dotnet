...
namespace Ingenico.Direct.Sdk.DefaultImpl
{
    ...
    public class DefaultAuthenticatorTest
    {
        ...
        public void TestTotalMinimalExample()
        {
            ...
            string signature = authenticator.CreateSimpleAuthenticationSignature(HttpMethod.Get, new Uri("http://world.api-ingenico.com:8080/v2/9991/tokens/123456789"), httpHeaders);
            Assert.AreEqual("GCS v1HMAC:5e45c937b9db33ae:GBGzXMS7goBkU/0+hLNHp8itEfxQ28bqF4NCHC55TEw=", signature);
        }
        ...
        public void TestTotalFullExample()
        {
            ...
            httpHeaders.Add(new RequestHeader("Date", "Fri, 06 Jun 2014 13:39:43 GMT"));
            string signature = authenticator.CreateSimpleAuthenticationSignature(HttpMethod.Delete, new Uri("http://world.api-ingenico.com:8080/v2/9991/tokens/123456789"), httpHeaders);
            Assert.AreEqual("GCS v1HMAC:5e45c937b9db33ae:XaFRF8Ji8pQli6O0aU6CRR7Cylg9kuUapll9vduNwIg=", signature);
        }
    }
}
